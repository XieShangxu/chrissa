    ...
    <div className="min-h-screen relative overflow-hidden text-white">
      ...
      <div className="relative z-20 min-h-screen flex flex-col">
        ...
        <nav className="flex justify-between items-center p-4 md:p-8">
          <div className="flex items-center space-x-2 md:space-x-4">
            <div className="flex items-center">
              <h1 className="text-xl md:text-2xl font-bold text-shadow-sm">
                Chrissa
              </h1>
              <span className="text-orange-500 ml-1">→</span>
            </div>
            <p className="text-sm md:text-base text-gray-200 text-shadow-sm truncate max-w-[120px] md:max-w-none">
              chrissa@example.com
            </p>
          </div>
        ...
        <main className="flex-1 flex flex-col px-4 py-6 md:p-8">
          {/* Introduction section - Centered on mobile */}
          <div className="mb-12 md:mb-0 text-center md:text-left md:max-w-md">
            <h2 className="text-4xl md:text-5xl font-bold text-shadow-md mb-4">
            ...
            <div className="pt-6 md:pt-8">
              <button className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-2 md:px-8 md:py-3 rounded-full flex items-center mx-auto md:mx-0 transition-all">
          ...
          <div className="hidden sm:block absolute top-1/4 right-10 w-12 h-12 md:w-16 md:h-16 border-2 border-cyan-400 rounded-full opacity-80"></div>
          <div className="hidden sm:block absolute top-1/4 right-12 w-3 h-3 md:w-4 md:h-4 bg-orange-500 rounded-full"></div>
          <div className="hidden sm:block absolute bottom-1/4 right-16 w-6 h-6 md:w-8 md:h-8 bg-cyan-400 rounded-full opacity-80"></div>
        ...
        <footer className="p-4 md:p-8 mt-auto">
          ...
          <div className="flex justify-center md:justify-between items-center flex-wrap gap-4">
            <div className="flex space-x-6">
              <Link href="#" className="text-white text-shadow-sm">
            ...
            {/* Website URL - Hidden on smaller screens */}
            <div className="hidden md:flex items-center">
              <div className="h-5 w-5 rounded-full bg-pink-500 flex items-center justify-center text-xs mr-2">
                D
              </div>
            ...
            <div className="w-full md:w-auto mt-6 md:mt-0">
              <button className="w-full md:w-auto bg-black/30 backdrop-blur-sm border border-gray-700 text-white px-4 py-2 rounded-md flex items-center justify-center">
                Let's Chat
